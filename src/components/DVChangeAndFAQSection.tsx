      ...
      <div className="container mx-auto px-8 lg:px-16">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-serif font-bold text-foreground mb-6">
            {currentItem.type === "section" ? "DV有可能改变吗？" : "DV相关常见Q及其A"}
            <br />
